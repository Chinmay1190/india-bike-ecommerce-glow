      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <Link to="/" className="font-bold text-xl">SuperBikes</Link>
            <p className="text-muted-foreground text-sm">
              Premium superbikes and motorcycles in India. 
              Experience the thrill of riding with our high-performance machines.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="text-muted-foreground hover:text-bike transition-colors">
              ...
              {categories.map((category) => (
                <li key={category.id}>
                  <Link 
                    ...
                    className="text-muted-foreground hover:text-bike transition-colors"
                  >
                    {category.name}
                  </Link>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start space-x-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="mt-1 text-muted-foreground"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/></svg>
                <span className="text-muted-foreground">
                  123 SuperBikes Avenue, <br />
              ...
              <li className="flex items-center space-x-2">
                ...
                <span className="text-muted-foreground">info@superbikes.com</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-12 pt-6 border-t border-muted text-center">
          <p className="text-muted-foreground text-sm">
            © {year} SuperBikes. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
